...
const ReportContent: React.FC<ReportContentProps> = ({ patientId, isModal = false, onClose }) => {
    ...
    return (
        <div className={`bg-gray-100 min-h-screen print:bg-white print:p-0 ${isModal ? 'p-4' : 'p-8'}`}>
            {/* Print Controls */}
            <div className="no-print mb-6 flex justify-between items-center max-w-5xl mx-auto">
                {isModal ? (
                    <button onClick={onClose} className="bg-gray-600 hover:bg-gray-700 text-white px-6 py-3 rounded-lg font-semibold transition flex items-center">
