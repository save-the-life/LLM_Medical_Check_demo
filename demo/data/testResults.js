        ...
        groups: [
            {
                groupName: '신체계측',
                results: [
                    { name: '신장', value: '180.4', unit: 'cm', reference: '-', status: 'normal' },
                    { name: '체중', value: '76.4', unit: 'kg', reference: '-', status: 'normal' },
                    { name: '체질량지수(BMI)', value: '23.5', unit: 'kg/m2', reference: '18.5~22.9', status: 'high' },
                    { name: '체지방율', value: '21.7', unit: '%', reference: '11~20', status: 'high' },
                    { name: '허리둘레', value: '85', unit: 'cm', reference: '0~90', status: 'normal' }
                ]
            },
            {
                groupName: '혈압',
                results: [
                    { name: '혈압(수축기)', value: '125', unit: 'mmHg', reference: '100~140', status: 'normal' },
                    { name: '혈압(이완기)', value: '82', unit: 'mmHg', reference: '60~90', status: 'normal' },
                    { name: '맥박', value: '70', unit: '', reference: '60~100', status: 'normal' }
                ]
            },
            {
                groupName: '혈액검사',
            ...
            },
            {
                groupName: '당뇨검사',
                results: [
                    { name: '공복혈당', value: '105', unit: 'mg/dL', reference: '70~100', status: 'high' },
                    { name: '당화혈색소(HbA1c)', value: '5.8', unit: '%', reference: '<5.7', status: 'high' }
                ]
            }
        ]
    }
...
// 특정 그룹 검사 결과 조회
function getTestResultsByGroup(patientId, groupName) {
    const results = MOCK_TEST_RESULTS[patientId];
    if (!results) return null;
    return results.groups.find(g => g.groupName === groupName);
}

// 검사 항목 목록
const TEST_GROUPS = [
    { id: 'body', name: '신체계측', icon: 'fa-weight' },
    { id: 'blood_pressure', name: '혈압', icon: 'fa-heartbeat' },
    { id: 'blood', name: '혈액검사', icon: 'fa-tint' },
    { id: 'liver', name: '간기능검사', icon: 'fa-stethoscope' },
    { id: 'kidney', name: '신기능검사', icon: 'fa-notes-medical' },
    { id: 'lipid', name: '고지혈검사', icon: 'fa-vial' },
    { id: 'diabetes', name: '당뇨검사', icon: 'fa-syringe' },
    { id: 'thyroid', name: '갑상선기능검사', icon: 'fa-prescription' },
